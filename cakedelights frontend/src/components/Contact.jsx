	...
	<div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
		...
		<div noValidate="" className="text-rose-800 flex flex-col py-6 space-y-6 md:py-0 md:px-6 ng-untouched ng-pristine ng-valid">
			<label className="block">
				...
				<input onChange={onChange1} required id="name" type="text" placeholder="Amit Ghoslya " className="block w-full rounded-md shadow-sm focus:ring focus:ring-opacity-75 p-2 focus:ring-rose-400 " />
			</label>
			<label className="block">
